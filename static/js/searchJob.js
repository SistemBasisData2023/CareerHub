          ...
          var jobItemContent = `
            <div class="row g-4">
              <div class="col-sm-12 col-md-8 d-flex align-items-center">
                <img class="flex-shrink-0 img-fluid border rounded" src="/static/img/com-logo-1.png" alt="" style="width: 80px; height: 80px;">
...
function loadDefaultList(){
  const url = `http://127.0.0.1:5000/defaultjobList`;
  fetch(url, {
    method: "GET",
    headers: {
      "Content-Type": "application/json"
...
function exploreByCategory(value) {
  const reqData = {
    key: "nama_kategori", // Ubah nama_kategori menjadi string "nama_kategori"
    data: value
  };
  console.log(reqData);
  const params = new URLSearchParams(reqData);
  const url = `http://127.0.0.1:5000/searchJob?${params}`;
